    ...
    <div>
      ...
      {showAdd && gmMode && (
        <div className="bg-surface-2 p-4 rounded mb-4 space-y-3">
          <div>
            <label className="block text-xs text-fg-muted mb-1">Skill Name</label>
            <input
              value={newSkillName}
            ...
            />
            <p className="text-xs text-fg-faint mt-1">Any GURPS skill can be added</p>
          </div>
      ...
      {cookingSkills.length === 0 ? (
        ...
        <div className="space-y-2">
          {cookingSkills.map(skill => (
            <div key={skill.id} className="bg-surface-2 rounded p-3 flex items-center gap-3">
