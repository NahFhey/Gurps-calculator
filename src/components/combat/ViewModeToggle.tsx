    ...
    <div className="flex items-center gap-2">
      ...
      <button
        ...
        className={`
          ...
          ${isGMView
            ? 'bg-danger-900/30 text-danger-400 border-2 border-danger-500/50 hover:bg-danger-900/40'
            : 'bg-accent-900/30 text-accent-400 border-2 border-accent-500/50 hover:bg-accent-900/40'
          }
        `}
      ...
      {isPlayerView && (
        <div className="text-xs text-fg-faint italic ml-2">
      ...
      {isGMView && (
        <div className="flex items-center gap-2 px-3 py-1 bg-danger-950/30 border border-danger-500/30 rounded text-xs text-danger-400">
          <EyeOff size={14} />
