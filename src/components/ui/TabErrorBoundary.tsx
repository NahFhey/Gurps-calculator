      ...
      return (
        <div className="flex flex-col items-center justify-center h-full p-8 text-center">
          <div className="max-w-md">
            <svg
              className="w-12 h-12 mx-auto text-danger-500 mb-4"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
            ...
            <h2 className="text-lg font-semibold text-fg-bright mb-2">
              {this.props.tabName} encountered an error
            </h2>
            {this.state.error?.message && (
              <p className="text-sm text-danger-400 bg-surface-1 p-3 rounded mb-4 font-mono">
                {this.state.error.message}
              </p>
            )}
            ...
            <button
              ...
              className="px-4 py-2 bg-accent-500 text-white rounded hover:bg-accent-600 transition-colors text-sm"
            >
              Retry
            </button>
          </div>
