 ...
 */
function MetricCard({ title, value, unit, icon: Icon, trend, warning }: MetricCardProps): React.JSX.Element {
  return (
 ...
 */
function StatsTable({ stats, title }: StatsTableProps): React.JSX.Element {
 ...
 */
function SlowOperationsList(): React.JSX.Element {
 ...
 */
export default function PerformanceDashboard({ defaultOpen = false }: PerformanceDashboardProps): React.JSX.Element {
