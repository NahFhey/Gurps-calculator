...
type NavigableView = 'fishing' | 'foraging' | 'mining' | 'alchemy' | 'crafting' | 'cooking' | 'rest' | 'trading';
...
export function DowntimePanel({ currentDayKey, currentSlot }: DowntimePanelProps) {
  ...
  const disabledActivities = useMemo(() => {
    ...
    const activityIds: Array<Exclude<NavigableView, 'rest' | 'trading'>> = ['fishing', 'foraging', 'alchemy', 'crafting', 'cooking'];
