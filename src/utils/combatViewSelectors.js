import { RevealMode, getRevealForInstance } from './combatReveal.js';

export function getDefenderDefenseBase(combatState, defenderId, type) {
  if (!combatState || !defenderId || !type) return null;
  const defender = combatState.participants.find(p => p.instanceId === defenderId);
...
export function getPublicDefenderLabel(combatState, revealState, defenderId) {
...
export function getPublicDefenseLabel(combatState, revealState, defenderId, type) {
