...
**Remaining (session 3):** ConditionAddPopover two-surface extraction (tracker + map token); "+N" overflow pills (4 tracker / 3 timeline); table verification.
