...
- Responsive layout improvements — **PARKED (2026-09-01)** pending a dedicated UI/UX design session: Devin wants to go over the design together (grill-me style) and refine it with prototypes before any layout sweep. Don't implement ad hoc.
- Dark mode / theme support — **PARKED (2026-09-01)**, same design session. The real work is theme tokens (CSS variables) across ~192 components of hardcoded Tailwind grays; whether a light theme is even wanted is a design question for that session.
